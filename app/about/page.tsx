    ...
    <Section title={about.title} subtitle={about.subtitle}>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <RevealOnScroll delay={150}>
          <div className="surface-card p-7 bg-gradient-to-b from-[var(--bg-glow-1)] to-white h-full">
            <div className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-3 py-1 text-xs font-semibold text-slate-600">
              <Stethoscope size={14} className="text-[var(--accent-color)]" />
              גישה רפואית מתקדמת
            </div>
            <h3 className="mt-4 font-bold text-2xl text-slate-900">{about.approachTitle}</h3>
            <p className="mt-3 text-slate-600 leading-relaxed">{about.approachText}</p>
      ...
      <RevealOnScroll delay={100}>
        <div className="mt-8 rounded-2xl border border-slate-200 bg-gradient-to-b from-[var(--bg-glow-2)] to-white p-6">
          ...
          <StaggerReveal className="mt-4 grid gap-4 md:grid-cols-2">
      ...
      {gallery.items.length > 0 ? (
        <RevealOnScroll delay={100}>
          <div className="mt-10">
            ...
            <StaggerReveal className="grid gap-3 grid-cols-2 md:grid-cols-3" staggerMs={80}>
